...
def inicializar_banco():
    ...
    # Tabela de Configurações e Licenciamento
    cursor.execute("""
    ...
    # Tabela de Consertos e Manutenções (Suporta múltiplos status)
    cursor.execute("""
...
# =========================================================
# 3. VERIFICAÇÃO DE SEGURANÇA E LICENÇA (90 DIAS)
# =========================================================
def verificar_licenca():
    ...
    if dias_passados > 90:
        ...
        st.write("A licença temporária de uso de 90 dias expirou. Insira o Código Master para liberar o acesso contínuo.")
        ...
        if st.button("Desbloquear Sistema"):
            if codigo == "202739":
                ...
                conn.commit()
                conn.close()
                st.success("Licença desbloqueada e validada com sucesso! Recarregando sistema...")
                st.rerun()
            else:
...
# =========================================================
# 4. SISTEMA DE AUTENTICAÇÃO SIMPLES / LOGIN
# =========================================================
...
if menu == "📊 Visão Geral / Dashboard":
    ...
    if search:
        df_exibir = df_pecas[
            df_pecas['nome'].str.contains(search, case=False, na=False) |
            df_pecas['codigo'].str.contains(search, case=False, na=False) |
            df_pecas['ncm'].str.contains(search, case=False, na=False)
        ]
    else:
        df_exibir = df_pecas
...
# =========================================================
# MÓDULO 2: GESTÃO DE CONSERTOS (COM TROCA DE STATUS)
# =========================================================
    ...
    if df_consertos.empty:
        ...
        for idx, row in df_consertos.iterrows():
            ...
            with col_status:
                # SELETOR DE STATUS FLEXÍVEL ("Em Conserto" <-> "Em espera de coleta")
...
# =========================================================
# MÓDULO 5: HISTÓRICO DE MOVIMENTAÇÕES
# =========================================================
